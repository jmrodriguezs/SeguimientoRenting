...
class Doc(BaseDocTemplate):
    ...
    def decorate(self, canv, doc):
        ...
        canv.drawRightString(A4[0] - doc.rightMargin, A4[1] - 1.35*cm, "Versión 1.2.2 · %s" % datetime.date.today().strftime("%d/%m/%Y"))
...
story += [cover_tbl, Spacer(1, 0.8*cm),
          Paragraph("Versión 1.2.2 · %s · Todas las capturas de este manual usan datos ficticios de ejemplo." % datetime.date.today().strftime("%B %Y").capitalize(), st["cap"])]
